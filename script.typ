...
== Cultural Background
Now for an interlude: I’m assuming a lot of you are familiar with the Sapir-Whorf hypothesis, but for anyone who isn’t, it conjectures that the language we speak determines the way we think. This hypothesis is from the 1920s, and most of modern linguistics considers this to be abject nonsense. Why am I talking about this? Well, the relationship between the Elves and Elvish is the exact opposite. That is, many aspects of the Elvish language are a direct consequence of the strict rules and hierarchy of Elvish society. Thus, in order to understand Elvish, we must understand the Elves themselves.
...
For example, take the word for ‘cane’, #w[dį́gá] #sd[slide], which has work order 11. Forming #w[xúnną dį́gá] has the effect of raising the work order of #w[dį́gá] to #s[w5] since $11-6=5$; thus, this phrase is suitable for referring to a cane that performs as much work as a Head Miner or which belongs to a Head Miner.
...
== Tense
There are two central aspects of Elvish grammar. One is work order, which we just discussed. The other is tense. The Elvish tense system is based on the hibernation cycle of The Chimney Man. #sd[slide] The Chimney Man wakes up and is awake on Christmas Eve. Starting at round 29 December, the Chimney Man enters REM sleep before sinking further into Non-REM Phases 1, 2, and 3 on 4 May, 26 August, and 10 November.

These five phases form the five Elvish tenses, which are each marked by a particle that precedes the verb. For instance, the REM Tense lasts from 29 December to 3 May. So, how exactly does this work? At any point in time, the Present Tense in Elvish is whatever sleep phase The Chimney Man is in when the utterance is spoken. For instance, on 2 February, The Chimney Man is in REM sleep, and thus, the REM Sleep Tense is the Present Tense. The tense after that, in this case the Non-REM Phase 1 Tense, is the Future Tense, and the tense after that forms a future-in-the-future. Similarly, the tense preceding the current tense is the Past Tense, in this case the Awake Tense, and tense before that serves as the pluperfect.
...
Let me paint you a picture: #sd[_Literally_ show a timelapse of you drawing an Elf while you’re explaining what Elves look like] The body and mental state of an Elf is optimised for the mining of Coal, with all unnecessary aspects of life removed. The complexion of an Elf is a dark grey, because they are always covered in layers of Coal dust. As the Elvish eye is designed to thrive in dry and dusty environments, Elves never need to close their eyes and thus lack eyelids. The only protection around their eyes is formed by multiple layers of eye lashes, which keep the Coal dust out of their vision.

The throats and mouths of Elves are likewise covered in dust, making Elvish articulation extremely hoarse and grating. Their tongues are stiff and don’t bend. Elves also have no lips, making their sharp and pointy teeth, which are perpetually stained black by the consumption of Coal, clearly visible; it is also for this reason that Elvish lacks labial sounds and rounded vowels.
...
Lastly, Elves have no gender and are all referred to as ‘it’. They don’t, and cannot, reproduce and are instead all created by The Chimney Man.
