...
As ever, let’s start by talking about the phonology of Elvish. The table here shows the Elvish consonant phoneme inventory #sd[Show Sindarin phoneme table]. The consonants are #sd[start reading the consonants, up to the middle of the 'stop' row, then interrupt]... wait hold on that doesn’t look right. Er... #sd[1/2 second pause], I think I got the wrong table. Where did I... Er, whatever, I bet y’all are tired of conlang reviews starting off with the phonology section anyway.

Y’know reading out sounds is nice and all, but I feel like in order to get a proper understanding of the language, we should start with a sentence so we can fully appreciate the elegance and euphony of the Elvish language. Recently, I gave our Discord members a short sentence in Elvish and asked them to provide their best attempt at a rendition of it. This is what I got #sd[Play everyone’s audio clips as usual].

What can I say, an attempt was made I suppose. Sorry guys, but you got it all wrong, though I saw some of you caught on to what was happening this time when we didn’t provide any IPA, but the _correct_ way to pronounce this sentence is obviously #sd[Show slide w/ IPA and read the sentence].
